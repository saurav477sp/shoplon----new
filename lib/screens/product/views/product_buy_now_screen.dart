...
import 'package:college_project/screens/product/views/added_to_cart_message_screen.dart';
import 'package:college_project/screens/product/views/components/product_list_tile.dart';
import 'package:college_project/screens/product/views/location_permission_store_availability_screen.dart';
              ...
              slivers: [
                ...
                SliverToBoxAdapter(
                  child: Obx(
                    () => SelectedSize(
                      ...
                      selectedIndex: selectedSizeIndex.value,
                      press: (value) {
                        selectedSizeIndex.value = value;
                      },
                    ),
                  ),
                ),
                SliverPadding(
                  ...
                  sliver: ProductListTile(
                    ...
                    press: () {
                      // right now sizeguide page is not ready

                      // customModalBottomSheet(
                      //   context,
                      //   height: MediaQuery.of(context).size.height * 0.9,
                      //   child: const SizeGuide(),
                      // );
                    },
                  ),
                ),
