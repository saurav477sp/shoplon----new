...
import 'package:college_project/screens/auth/views/components/sign_up_form.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void signUp() async {
    await firebaseUserAuth.signUpWithEmailAndPassword(
