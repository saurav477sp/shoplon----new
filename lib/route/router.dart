import 'package:college_project/screens/user_info/views/edit_user_info_screen.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    // case otpVarificationCodeRoute:
    //   return MaterialPageRoute(
    //     builder: (context) => const OtpVarificationCode(),
    //   );
